...
const DEFAULT_BOT_MESSAGE = {
  text:
    " Before you sign anything, upload it here or ask questions. I will show you if any part violates the law. Works for rent, loans, and job offers.",
  isBot: true,
};
          ...
          (prev) => {
            ...
            return [
              ...withoutTyping,
              {
                ...
                text:
                  "⚠️ There was an error connecting to the server.",
    ...
    <div className="App">
      ...
      >
        ...
        <div className='chatfooter'>
          ...
          <p>
            ~ Africa’s Legal Intelligence Engine ~
          </p>
